        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '48px', marginBottom: '64px' }}>
          ...
          <div>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.92rem', lineHeight: 1.7, marginBottom: '24px' }}>
              Pioneering 2026 architectural luxury, high-end interior design, and bespoke spatial craftsmanship worldwide.
            </p>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {[
                ...
                { label: '3D Material Visualizer', href: '#materials' },
                { label: 'Cost Estimator ($ / ₹)', href: '#calculator' },
                { label: 'Style Signature Quiz', href: '#style-quiz' }
              ].map(item => (
                <a 
                  key={item.label} 
                  href={item.href} 
          ...
          <div>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.88rem', marginBottom: '16px' }}>
              Receive exclusive quarterly design insights, 3D architectural trends, and project unveils.
            </p>
            ...
            <form onSubmit={handleSubscribe} style={{ display: 'flex', gap: '8px' }}>
              ...
              />
              <button type="submit" className="btn-gold" style={{ padding: '12px 18px' }}>
                <ArrowRight size={18} />
              </button>
            </form>
          </div>
